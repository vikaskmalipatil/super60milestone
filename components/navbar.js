  ...
  return (
    <div>
      <nav className="flex items-center justify-between px-12 py-6 bg-white dark:bg-[#262525] ">
        <button
          className="md:hidden  left-0 text-2xl"
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/reservation">
            <button className="bg-[#8b6b39] hidden md:flex text-white font-semibold py-3 px-10 rounded-full hover:bg-black transition">
              Reservation
            </button>
          </Link>
        </div>
