...
export default function Home() {
  return (
    <div className="overflow-x-hidden">
      <Navbar />
      <div className="bg-[url('https://aluxurylifestyle.com/wp-content/uploads/2025/01/luxury_rare_foods_experience.jpg')] bg-cover bg-center min-h-[80vh] w-full flex flex-col text-white">
