    ...
    <section className="bg-white flex flex-col items-center justify-center ">
      {standardblogs.map((item, index) => (
        <div key={index} className="flex">
          <div className="relative mt-15 w-250 h-auto mb-10  rounded-xl shadow-lg  flex flex-col bg-white ">
            <img src={item.img} alt={item.blogname} className="w-250 h-135 rounded-xl " />
            ...
            <div className="mt-8">{item.content}</div>
