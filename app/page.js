...
export default function Home() {
  return (
    <div>
      <Navbar />
      <div className="bg-[url('https://restan-nextjs.vercel.app/assets/img/banner/13.jpg')] bg-cover bg-center min-h-[80vh] w-full flex flex-col justify-between text-white">
      ...
      <div className="relative flex w-full min-h-[70vh] bg-white dark:bg-[#1D1D1D]">
        ...
        <div className="flex justify-center items-center w-1/2 bg-[#8b6b3e]">
          <div>
            <h2 className="text-3xl font-bold text-white mb-4 bg-gray-600">
              Opening Hours
            </h2>
